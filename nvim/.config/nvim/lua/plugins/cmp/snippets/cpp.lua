...
local snips = {
  ...
  private:
      <members>
  };]], { Name = i(1, 'Name'), Name2 = i(1, 'Name'), ctor_args = i(2, ''), Name3 = i(1, 'Name'), members = i(3, '') })),

  s('strc', fmta('struct <Name> {\n    <body>\n};', { Name = i(1, 'Name'), body = i(2, '') })),

  s('ns', fmta('namespace <name> {\n    <body>\n} // namespace <name2>',
  ...
  s('lam', fmta('auto <name> = [<capture>](<args>) -> <Ret> {\n    <body>\n};',
    { name = i(1, 'fn'), capture = i(2, ''), args = i(3, ''), Ret = i(4, 'void'), body = i(5, '') })),

  s('forr', fmta([[
  for (<Type> <name> : <iter>) {
      <body>
  }]], { Type = c(1, { t 'auto', t 'auto const&', t 'auto&' }), name = i(2, 'item'), iter = i(3, ''), body = i(4, '') })),
  ...
  try {
      ...
      <handler>
  }]], { body = i(1, ''), Exc = i(2, 'const std::exception&'), e = i(3, 'e'), handler = i(4, 'std::cerr << e.what() << \'\\n\';') })),

  s('uniq', fmta('auto <name> = std::make_unique<<Type>>(<args>);',
    { name = i(1, 'p'), Type = i(2, 'T'), args = i(3, '') })),

  s('shrd', fmta('auto <name> = std::make_shared<<Type>>(<args>);',
    { name = i(1, 'p'), Type = i(2, 'T'), args = i(3, '') })),

  s('vec', fmta('std::vector<<Type>> <name><init>;',
    { Type = i(1, 'int'), name = i(2, 'v'), init = c(3, { t '', t '{}', t '(n)', t '{a, b, c}' }) })),
