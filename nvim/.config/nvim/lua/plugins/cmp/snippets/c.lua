...
local snips = {
  ...
  s(
    'forr',
    fmta('for (<Type> <i> = <start>; <i2> < <end>; <i3>++) {\n    <body>\n}', {
      Type = i(1, 'int'),
      i = i(2, 'i'),
      start = i(3, '0'),
      i2 = i(2, 'i'),
  ...
  typedef struct <Name> {
      ...
      { Name = i(1, 'Name'), fields = i(2, ''), Name2 = i(1, 'Name') }
    )
  ),
  ...
  typedef enum {
      ...
      { values = i(1, ''), Name = i(2, 'Name') }
    )
  ),

  s(
    'mal',
    fmta('<Type> *<name> = malloc(<count> * sizeof(<Type2>));\nif (!<name2>) { <err> }', {
      Type = i(1, 'int'),
      name = i(2, 'p'),
      count = i(3, 'n'),
      Type2 = i(1, 'int'),
  ...
  #endif]],
      { GUARD = i(1, 'HEADER_H'), GUARD2 = i(1, 'HEADER_H'), body = i(2, '') }
    )
  ),
}
