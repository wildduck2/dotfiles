...
ls.add_snippets('rust', {
  s('fnr', fmta(
    ...
    { name = i(1, 'name'), args = i(2, ''), Ok = i(3, '()'), Err = i(4, 'anyhow::Error'), body = i(5, 'Ok(())') }
  )),
  ...
  s('implt', fmta('impl <Trait> for <Name> {\n    <body>\n}',
    { Trait = i(1, 'Trait'), Name = i(2, 'Name'), body = i(3, '') })),

  s('trait', fmta('pub trait <Name> {\n    <body>\n}',
  ...
  let <name> = match <expr> {
    ...
    { name = i(1, 'value'), expr = i(2, ''), Ok = c(3, { t 'Ok', t 'Some' }), Err = c(4, { t 'Err', t 'None =>' }) })),
  ...
  s('log', fmta('tracing::<level>!("<msg>"<args>);',
    { level = c(1, { t 'info', t 'debug', t 'warn', t 'error', t 'trace' }), msg = i(2, ''), args = i(3, '') })),
