import { Color, ColorInformation, ColorPresentation, CompletionContext, CompletionList, Diagnostic, Hover, Position, Range, SymbolInformation, SelectionRange, WorkspaceFolder } from 'vscode-languageserver';
import { Document, DocumentManager } from '../../lib/documents';
import { LSConfigManager } from '../../ls-config';
import { ColorPresentationsProvider, CompletionsProvider, DiagnosticsProvider, DocumentColorsProvider, DocumentSymbolsProvider, FoldingRangeProvider, HoverProvider, SelectionRangeProvider } from '../interfaces';
import { CSSLanguageServices } from './service';
import { FoldingRange } from 'vscode-languageserver-types';
export declare class CSSPlugin implements HoverProvider, CompletionsProvider, DiagnosticsProvider, DocumentColorsProvider, ColorPresentationsProvider, DocumentSymbolsProvider, SelectionRangeProvider, FoldingRangeProvider {
    __name: string;
