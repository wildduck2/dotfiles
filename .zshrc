...
if [[ ":$FPATH:" != *":/home/wildduck/.zsh/completions:"* ]]; then export FPATH="/home/wildduck/.zsh/completions:$FPATH"; fi
...
export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"
. "/home/wildduck/.deno/env"

# bun completions
[ -s "/home/wildduck/.bun/_bun" ] && source "/home/wildduck/.bun/_bun"
